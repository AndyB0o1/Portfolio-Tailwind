fetch('portfolio.json').then(function (res) {
    ...
    <div class="specificProject sm:basis-1/3 bg-[#90AEAD] max-w-2xl border solid border white rounded-lg p-3">
        ...
        <div class="projectText">
            ...
            <p class="py-2"><a class="p-3 text-orange-100 text-l bg-cyan-900 rounded-lg sm:text-xl hover:bg-lime-300 hover:text-cyan-900 rounded-lg p-3" href="${project.url}" target="_blank">See it on github</a></p>
        </div>
    </div>`
    })
})
